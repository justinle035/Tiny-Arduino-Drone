...
/**************************   atmega328P (Promini)  ************************************/
    ...
    #define RCAUXPIN
  #endif
  #define I2C_PULLUPS_ENABLE         PORTC |= 1<<4; PORTC |= 1<<5;   // PIN A4&A5 (SDA&SCL) Nhat Nguyen da doi cho 4 va 5 o 2 dong nay 
  #define I2C_PULLUPS_DISABLE        PORTC &= ~(1<<5); PORTC &= ~(1<<4);
  #if !defined(MONGOOSE1_0)
